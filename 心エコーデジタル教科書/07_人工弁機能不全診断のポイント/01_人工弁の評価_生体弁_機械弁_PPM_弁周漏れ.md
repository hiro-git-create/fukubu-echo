...
| 鑑別項目 | 血栓 (Thrombus) | パネル (Pannus) |
| :--- | :--- | :--- |
| **発症速度** | **急性〜亜急性** (数日〜数週間) | **慢性** (数か月〜数年かけて進行) |
| **抗凝固療法** | ワーファリン効果不十分 (INR低下) | ワーファリン適正コントロール下 |
| **エコー輝度** | やや低〜中等度輝度、可動性あり | **高輝度（石灰化様）**、弁輪部に固着 |
| **治療方針** | 抗凝固・血栓溶解療法、緊急手術 | **手術によるPannus切除 / 弁再置換** |
