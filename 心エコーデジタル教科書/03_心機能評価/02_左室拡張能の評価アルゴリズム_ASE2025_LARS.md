...
| 指標 | カットオフ値 | 中隔 / 側壁 | 臨床的意義 |
| :--- | :---: | :---: | :--- |
| **e'（弛緩速度）** | 平均 ≤ 6.5 cm/s | ≤ 6 / ≤ 7 cm/s | 心筋弛緩能低下の指標 |
| **E/e' 比** | 平均 > 14 | > 15 / > 13 | 左室充満圧（LAP）上昇の指標 |
| **E/A 比** | ≤ 0.8 または ≥ 2.0 | — | 僧帽弁充満パターン異常 |

### Step 2 ── 詳細指標（セカンダリ）

| 指標 | カットオフ値 | 臨床的意義 |
| :--- | :---: | :--- |
| **★ LARS（ASE 2025 新導入）** | ≤ 18% | 早期の左房機能不全・LAP上昇の最高感度指標 |
| **LAVi** | > 34 mL/m² | 慢性的な左房圧負荷の指標 |
| **PV S/D** | ≤ 0.67 | 収縮期/拡張期血流比の低下（LAP上昇） |
| **TRV** | 補助指標のみ | 充満圧推定の補助（診断ステップから除外） |
