---
title: 肥大型心筋症 (HCM, HOCM, SAM)
tags: [心筋症, HCM, HOCM, SAM, ASH, APH, LVOT圧較差]
aliases: [Hypertrophic Cardiomyopathy, HCM, HOCM, SAM, Asymmetric Septal Hypertrophy]
date_created: 2026-07-31
last_modified: 2026-07-31
reference_guideline: AHA/ACC HCM Guidelines, JCS 2018
---
...
```mermaid
graph TD
    A[HCM の形態分類] --> B[1. 非対称性心室中隔肥大 ASH: 最多]
    A --> C[2. 心尖部肥大型心筋症 APH: 日本人に多い]
    A --> D[3. びまん性肥大型 / 同心性肥大型]
    
    B --> B1[中隔厚 / 後壁厚比 IVS/PW ≥ 1.3]
    C --> C1[心尖部壁厚 ≥ 15mm, 心電図巨大陰性T波]
```
...
| 評価項目 | 肥大型心筋症 (HCM) | 高血圧性心肥大 (Hypertensive) | 心アミロイドーシス |
| :--- | :--- | :--- | :--- |
| **肥大のパターン** | 非対称性 (ASH / IVS/PW $\ge 1.3$) | 求心性・均一 (Concentric) | びまん性肥厚・右室壁も肥厚 |
| **左室収縮能 (LVEF)**| **過収縮 (Hyperdynamic: EF>70%)**| 正常 | 正常〜低下 |
| **心筋エコー輝度** | 心筋の混乱 (Disarray) による斑状輝度 | 均一 | **Sparkling (粒状高エコー)** |
| **GLS パターン** | 肥厚部位の局所低下 | 均一な軽度低下 | **Apical Sparing (心尖部保持)** |
