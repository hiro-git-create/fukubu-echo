...
| 合併症 | 新性雑音 | 主要なエコー像 | 緊急対応 |
| :--- | :--- | :--- | :--- |
| **心室中隔穿孔 (VSP)** | 全収縮期雑音 (胸骨左縁) | 心室中隔欠損 + 左➔右収縮期ジェット | IABP/ECMO + 緊急VSP閉鎖術 |
| **乳頭筋断裂** | 収縮期全雑音 (心尖部) | 僧帽弁Flail + 巨大MRジェット | IABP + 緊急MVR (弁置換) |
| **仮性心室瘤** | 収縮期雑音 | 狭いネックを持つ心外膜側への瘤状突出 | 緊急仮性瘤切除・縫合閉鎖術 |
