...
| 指標 | 軽度 (Mild) | 中等度 (Moderate) | 重症 (Severe) | Massive / Torrential |
| :--- | :--- | :--- | :--- | :--- |
| **Vena Contracta (cm)** | $< 0.3$ | $0.3 \sim 0.69$ | **$\ge 0.7$** | $1.4 \sim 2.1+$ (巨大弁口) |
| **肝静脈血流波形** | 正常 (収縮期順行) | 収縮期波平坦化 | **収縮期逆行波 (Reversal)** | 顕著な収縮期逆行 |
| **右室・右房の形態** | 正常 | 正常〜やや拡大 | **右房・右室の著明拡大** | 右心不全・IVCパンパン |
| **TR CW波形** | 淡い・放物線状 | やや濃い | **非常に濃い・三角形状 (Cut-off)** | フラットな低速波形 |
