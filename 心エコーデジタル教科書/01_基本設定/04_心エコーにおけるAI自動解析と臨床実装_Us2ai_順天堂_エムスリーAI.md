...
| 評価項目 | 従来の通常検査（Manual） | AI支援検査（Us2.ai支援） | 臨床的効果・結果 |
| :--- | :---: | :---: | :--- |
| **1日あたりの検査完了件数** | 基準 | **18% 増加** | 検査スループットの飛躍的向上（待ち時間短縮） |
| **1検査あたりの平均計測項目数** | 25 項目 | **85 項目** | **約 3.4倍 の詳細データ**を網羅取得 |
| **検査技師の疲労感・負担度** | 高い | **有意に低下** | 計測ストレス軽減・タスクシフト（働き方改革） |
| **画像のクオリティ・計測再現性** | 検者依存あり | **大幅に改善** | ガイドライン準拠率100%の高品質データ生成 |
...
| 項目 | 臨床エッセンス |
| :--- | :--- |
| **1. 概要** | 順天堂大 × エムスリーAI × Us2.ai が主導する心エコー全自動AI解析プラットフォーム。 |
| **2. 精度** | 85項目以上のパラメータ（LVEF, GLS, LARS, 拡張能, 弁膜症）をガイドライン準拠で全自動計測。 |
| **3. エビデンス** | **AI-ECHO試験（AHA 2024）**において、**検査件数18%増・計測項目3.4倍・技師負担軽減**を臨床実証。 |
| **4. 現場のメリット** | 検者間誤差の追放、報告書作成の短縮、働き方改革と高度医療の両立。 |
