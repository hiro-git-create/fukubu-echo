...
| 疾患 | 主な心腔拡大 | 確定アプローチ | 特徴的ドプラ波形 | カテーテル治療 |
| :--- | :--- | :--- | :--- | :--- |
| **ASD** | **右房・右室拡大** | 剣状突起下4腔 / TEE | 左房から右房への舒張期・収縮期低速血流 | **Amplatzer等で閉鎖可能** |
| **VSD** | **左房・左室拡大** | PLAX / PSAX / AP5 | 左室から右室への収縮期高速血流 ($>4\text{m/s}$) | 条件付きで可能 |
| **PDA** | **左房・左室拡大** | PSAX 肺動脈分岐部 | 主肺動脈内への全心周期持続する**連続性血流** | **コイル/Amplatzer閉鎖** |
