...
| 計測項目 | 正常基準 (Normal) | SMA症候群 診断カットオフ (Abnormal) | 臨床的意義 |
| :--- | :--- | :--- | :--- |
| **AO-SMA 分岐角 (SMA Angle)** | **$45^\circ \sim 60^\circ$** | **$< 20^\circ$** (特に $< 22^\circ$) | 血管分岐の鋭角化・挟み込み |
| **AO-SMA 血管間距離 (A-S Distance)**| **$10 \sim 28 \text{ mm}$** | **$< 8.0 \text{ mm}$** (特に $< 5.0 \text{ mm}$) | 血管間隙の著明な狭小化 |
| **十二指腸水平部径 (Duodenum)** | **< 10.0 mm** (空腹時) | **> 20.0 mm** (閉塞部口側拡張) | 十二指腸水平部の機械的閉塞 |
