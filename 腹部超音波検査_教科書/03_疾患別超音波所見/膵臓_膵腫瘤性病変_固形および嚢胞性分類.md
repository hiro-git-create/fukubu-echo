...
```mermaid
graph TD
    PancreasMass["膵腫瘤性病変 Pancreatic Mass Lesions"] --> Solid["1. 固形腫瘤性病変 Solid Lesions"]
    PancreasMass --> Cystic["2. 嚢胞性腫瘤性病変 Cystic Lesions"]

    subgraph SubSolid ["固形腫瘤 (Solid)"]
        Solid --> PDAC["通常型膵がん PDAC: 浸潤性管がん 90%"]
        Solid --> NET["膵神経内分泌腫瘍 PanNET / PanNEN"]
        Solid --> SPN["Solid Pseudopapillary Neoplasm"]
        Solid --> AIP["自己免疫性膵炎 AIP / 腫瘤形成性膵炎"]
    end

    subgraph SubCystic ["嚢胞性腫瘤 (Cystic)"]
        Cystic --> Tumorous["腫瘍性嚢胞 Neoplastic Cysts"]
        Cystic --> NonTumorous["非腫瘍性嚢胞 Non-neoplastic Cysts"]
        
        Tumorous --> IPMN["IPMN: 膵管内乳頭粘液性腫瘍"]
        Tumorous --> MCN["MCN: 粘液性嚢胞腫瘍"]
        Tumorous --> SCN["SCN: 漿液性嚢胞腫瘍"]
        
        NonTumorous --> Pseudocyst["仮性嚢胞 Pseudocyst"]
        NonTumorous --> Retention["停留性嚢胞 Retention Cyst"]
    end
```
